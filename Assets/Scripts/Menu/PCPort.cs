...
public class PCPort : MonoBehaviour {
	...
	void Start () {
		...
		x.GetComponent<Transform>().Find("Body1").GetComponent<SpriteRenderer>().enabled = true;
		x.GetComponent<Transform>().Find("Body2").GetComponent<SpriteRenderer>().enabled = true;
	}
