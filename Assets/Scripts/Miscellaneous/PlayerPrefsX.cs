...
public class PlayerPrefsX{
	...
	public static void ClearStringArray(string key){ // PELLE FEZ ESSE
		PlayerPrefsX.SetStringArray(key, new string[0]);
	}

	public static void ClearIntArray(string key){ // PELLE FEZ ESSE
		PlayerPrefsX.SetIntArray(key, new int[0]);
	}
